...
//#include "../SCSLAM/Objects/Camera/ITMIntrinsics.h"
...
//    };
    ...
    namespace IO{
        ...
        public:
            enum INPUTDATATYPE {
                INPUTTYPE_SCANNET=0, INPUTTYPE_TUM=1
            };
            static std::string GetAllTypesInString(){
                return "0:INPUTTYPE_SCANNET, 1:INPUTTYPE_TUM";
            }
            static INPUTDATATYPE ToInputDateType(int i){
                if(i > 9) throw std::runtime_error("exceed enum limit\n");
        ...
        public:
            ...
            virtual int getDepth(int idx, ORUtils::Image<short> *depthptr)=0;
            ...
            float getDepthScale(){return scale_;}
