...
//        for (boost::property_tree::ptree::const_iterator it = pt.get_child("camera_location").begin();
//             it != end; ++it, ++i) {
...
//        for (boost::property_tree::ptree::const_iterator it = pt.get_child("camera_rotation_final").begin();
//             it != end; ++it, ++i) {
...
//    inline void print(boost::property_tree::ptree const &pt) {
