...
namespace ITMLib
{
	...
	public:
		...
		ITMTrackingState::TrackingResult ProcessFrame(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, ORUtils::Matrix4<float> *customPose = nullptr, ITMIMUMeasurement *imuMeasurement = NULL);
